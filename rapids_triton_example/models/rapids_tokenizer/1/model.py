...
class TritonPythonModel:
    ...
    def execute(self, requests):
        ...
        for request in requests:
            # Get INPUT0
            raw_strings = pb_utils.get_input_tensor_by_name(request, "raw_logs").as_numpy()
            ...
            out_tensor_0 = pb_utils.Tensor("input_ids", cudf_output['input_ids'].get())
            out_tensor_1 = pb_utils.Tensor("attention_mask", cudf_output['attention_mask'].get())
            out_tensor_2 = pb_utils.Tensor("metadata", cudf_output['metadata'].get())
