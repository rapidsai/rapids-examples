...
execute_process(
  COMMAND "/usr/bin/git" show-ref "cudf_0.16"
  WORKING_DIRECTORY "/home/jdyer/Development/rapids-examples/thirdparty/_deps/jitify-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/cudf_0.16")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "cudf_0.16")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "cudf_0.16")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/rapidsai/jitify.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/jdyer/Development/rapids-examples/thirdparty/_deps/jitify-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jdyer/Development/rapids-examples/thirdparty/_deps/jitify-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
