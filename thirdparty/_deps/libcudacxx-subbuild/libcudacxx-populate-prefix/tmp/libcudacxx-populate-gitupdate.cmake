...
if("${show_ref_output}" MATCHES "refs/remotes/1.4.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "1.4.0")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/NVIDIA/libcudacxx.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/jdyer/Development/rapids-examples/thirdparty/_deps/libcudacxx-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jdyer/Development/rapids-examples/thirdparty/_deps/libcudacxx-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
